...
dat <- fread("/data/users/jniklaus2/genome_annotation_2/genespace/orthofinder/Results_Dec24/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
# make sure the ratio is numeric
ortho_ratio$perc <- as.numeric(ortho_ratio$perc)
...
orthogroups <- fread("/data/users/jniklaus2/genome_annotation_2/genespace/orthofinder/Results_Dec24/Orthogroups/Orthogroups.GeneCount.tsv")
